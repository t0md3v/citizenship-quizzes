...
{ question: "Los canadienses tienen derechos y libertades fundamentales como", choices: ["Pensamiento y creencia", "Opinión y expresión", "Libertad de religión", "Todas las anteriores"], correct: 3 },
...
{ question: "Da un ejemplo de cómo podés demostrar responsabilidad participando en tu comunidad.", choices: ["Ocuparte solo de tus asuntos", "Organizar una fiesta", "Descuidar tu propiedad", "Hacer voluntariado"], correct: 3 },
  ...
  { question: "¿Qué océanos bordean las fronteras de Canadá?", choices: ["El océano Pacífico al oeste", "El océano Atlántico al este", "El océano Ártico al norte", "Todas las anteriores"], correct: 3 },
 { question: "¿Quién es el jefe de gobierno en Canadá?", choices: ["El Soberano", "El Primer Ministro", "El Primer Ministro provincial", "El Comisionado"], correct: 1 },
